...
def download_vqa(folder):
    ...
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Questions_Binary_Train2017_abstract_v002.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Questions_Binary_Val2017_abstract_v002.zip -P %szip/' % (args.folder))

    # Download VQA Questions (abstract)
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Questions_Train_abstract_v002.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Questions_Val_abstract_v002.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Questions_Test_abstract_v002.zip -P %szip/' % (args.folder))
    ...
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Annotations_Binary_Train2017_abstract_v002.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Annotations_Binary_Val2017_abstract_v002.zip -P %szip/' % (args.folder))

    # Download the VQA Annotations (abstract)
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Annotations_Train_abstract_v002.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/vqa/Annotations_Val_abstract_v002.zip -P %szip/' % (args.folder))
    ...
    os.system('wget http://visualqa.org/data/abstract_v002/scene_img/scene_img_abstract_v002_binary_train2017.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/scene_img/scene_img_abstract_v002_binary_val2017.zip -P %szip/' % (args.folder))

    # Download VQA Images (abstract scenes)
    os.system('wget http://visualqa.org/data/abstract_v002/scene_img/scene_img_abstract_v002_train2015.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/scene_img/scene_img_abstract_v002_val2015.zip -P %szip/' % (args.folder))
    os.system('wget http://visualqa.org/data/abstract_v002/scene_img/scene_img_abstract_v002_test2015.zip -P %szip/' % (args.folder))
    ...
    os.system('unzip %szip/train2014.zip -d %sImages/mscocoa/test2014/'%(folder, folder))
    os.system('unzip %szip/val2014.zip -d %sImages/mscocoa/val2014/'%(folder, folder))
    os.system('unzip %szip/test2015.zip -d %sImages/mscocoa/test2015/'%(folder, folder))

    os.system('unzip %szip/scene_img_abstract_v002_binary_train2017.zip -d %sImages/abstract_v002/train2017/'%(folder, folder))
    os.system('unzip %szip/scene_img_abstract_v002_binary_val2017.zip -d %sImages/abstract_v002/val2017/' %(folder, folder))

    os.system('unzip %szip/scene_img_abstract_v002_train2015.zip -d %sImages/abstract_v002/train2015/'%(folder, folder))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', required=False, default="", help='The path to the data directory. (default : current) if you want to install in data/')
